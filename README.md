...
**Fundsmith** is the most efficient way to batch distribute MON to multiple testnet addresses simultaneously on the Monad Testnet. Designed for developers, hackers, and teams building on Monad who need to quickly fund multiple test wallets in one single transaction.

## Features

- **Time-Saving**: Execute one transaction to fund dozens of wallets. Focus on building your dApp, not managing testnet funds manually.
...
- MON tokens on the Monad Testnet ([Faucet](https://testnet.monad.xyz/))
...
2. Ensure you are connected to the **Monad Testnet**.
